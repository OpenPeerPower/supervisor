...
from .openpeerpower.core import LANDINGPAGE
...
class Core(CoreSysAttributes):
    ...
    async def start(self):
        ...
        try:
            # OpenPeerPower is already running / supervisor have only reboot
            ...
            if (
                ...
                _LOGGER.info("Start Open Peer Power Core")
                try:
                    await self.sys_openpeerpower.core.start()
                except OpenPeerPowerCrashError as err:
                ...
                _LOGGER.info("Skiping start of Open Peer Power")
