...
SCHEMA_UPDATER_CONFIG = vol.Schema(
    {
        ...
        vol.Optional(ATTR_OPENPEERPOWER): version_tag,
        vol.Optional(ATTR_SUPERVISOR): version_tag,
        vol.Optional(ATTR_OPPOS): version_tag,
        ...
        vol.Optional(ATTR_IMAGE, default=dict): vol.Schema(
            {
                vol.Optional(ATTR_OPENPEERPOWER): docker_image,
...
SCHEMA_SUPERVISOR_CONFIG = vol.Schema(
    {
        ...
        vol.Optional(
            ATTR_ADDONS_CUSTOM_LIST,
            default=["https://github.com/oppio-addons/repository"],
        ): repositories,
