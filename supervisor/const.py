...
FILE_OPPIO_ADDONS = Path(SUPERVISOR_DATA, "addons.json")
FILE_OPPIO_AUTH = Path(SUPERVISOR_DATA, "auth.json")
...
LABEL_ARCH = "io.opp.arch"
LABEL_MACHINE = "io.opp.machine"
LABEL_TYPE = "io.opp.type"
