...
SCHEMA_ADDON_CONFIG = vol.Schema(
    {
        ...
        vol.Optional(ATTR_OPPIO_API, default=False): vol.Boolean(),
        vol.Optional(ATTR_OPPIO_ROLE, default=ROLE_DEFAULT): vol.In(ROLE_ALL),
        vol.Optional(ATTR_OPENPEERPOWER_API, default=False): vol.Boolean(),
...
def _single_validate(coresys: CoreSys, typ: str, value: Any, key: str):
    ...
    if str(value).startswith("!secret "):
        ...
        value = coresys.openpeerpower.secrets.get(secret)
        if value is None:
